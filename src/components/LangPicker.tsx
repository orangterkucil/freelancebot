  ...
  return (
    <div className="relative" ref={wrap}>
      <button
        ...
        className={
          "inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-white/90 text-slate-700 shadow-sm backdrop-blur transition-colors hover:border-brand hover:text-brand" +
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-xl border border-slate-200 bg-white p-1 shadow-lg">
          {LOCALES.map((l) => {
